        ...
        <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-slate-700 to-slate-800 px-8 py-6">
                <div class="text-center">
                    ...
                    <p class="text-slate-300 text-sm">{{ __('Enter your email address and we will send you a link to reset your password.') }}</p>
                </div>
            </div>
            ...
            <div class="p-8">
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <button type="submit" 
                        ...
                        <span class="relative z-10">{{ __('Send Password Reset Link') }}</span>
                    </button>

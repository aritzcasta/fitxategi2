        ...
        <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
            ...
            <div class="p-8">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-5">
                        <label for="empresa_id" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">{{ __('Empresa') }}</label>
                    ...
                    <div class="mb-5">
                        <label for="fecha_fin" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">{{ __('Fecha fin') }}</label>
                        <input id="fecha_fin" 
                               type="date" 
                               class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:border-slate-600 focus:bg-white dark:focus:bg-gray-600 focus:ring-4 focus:ring-slate-200 dark:focus:ring-slate-700 transition" 
                               name="fecha_fin" 

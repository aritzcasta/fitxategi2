...
<div class="max-w-md mx-auto">
    <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-red-600 to-red-700 px-8 py-6">
            <div class="flex items-center justify-center gap-4">
                ...
                <div class="text-center">
                    ...
                    <p class="text-red-100 text-sm">Área de seguridad - Verificación requerida</p>
                </div>
            </div>
        </div>
        ...
        <!-- Contenido -->
        <div class="p-8">
            <div class="bg-red-50 dark:bg-red-900/20 rounded-2xl p-6 border-2 border-red-200 dark:border-red-800 mb-6">
            ...
            @if ($errors->any())
                <div class="mb-6 px-6 py-4 rounded-2xl text-sm font-medium shadow-lg border bg-red-50 text-red-800 border-red-200 dark:bg-red-900/30 dark:text-red-200 dark:border-red-800">
            ...
            <form method="POST" action="{{ route('admin.borrar-usuarios.verify') }}">
                @csrf
                <div class="mb-6">
                ...
                <div class="flex gap-3">
                    ...
                    <button type="submit"
                            class="flex-1 px-6 py-4 rounded-xl font-semibold text-white bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 transition-all duration-200 shadow-lg hover:shadow-xl">
                        Verificar
                    </button>
                </div>
            </form>

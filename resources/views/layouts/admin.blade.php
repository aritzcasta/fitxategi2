        ...
        <aside class="hidden md:flex md:flex-col w-72 bg-white dark:bg-gray-800 border-r-2 border-gray-200 dark:border-gray-700 min-h-screen shadow-xl">
            ...
            <nav class="p-4 flex-1">
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="{{ route('admin.festivos') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all duration-200 {{ request()->routeIs('admin.festivos') ? 'bg-slate-700 text-white shadow-lg border-2 border-emerald-700' : 'text-gray-700 dark:text-gray-200 hover:bg-slate-100 dark:hover:bg-slate-800' }}">
                    ...
                    <li>
                        <a href="{{ route('admin.borrar-empresas') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all duration-200 {{ request()->routeIs('admin.borrar-empresas*') ? 'bg-slate-700 text-white shadow-lg border-2 border-orange-600' : 'text-gray-700 dark:text-gray-200 hover:bg-slate-100 dark:hover:bg-slate-800' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                            <span>Borrar Empresas</span>
                        </a>
                    </li>
                    <li>
            ...
            <header class="w-full bg-white dark:bg-gray-800 border-b-2 border-gray-200 dark:border-gray-700 shadow-lg">
                ...
                <div id="mobile-menu" class="md:hidden hidden px-4 py-3 border-t border-gray-200 dark:border-gray-700 bg-slate-50 dark:bg-slate-900">
                    <nav class="space-y-1">
                        ...
                        <a href="{{ route('admin.borrar-empresas') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-slate-200 dark:hover:bg-slate-800 transition">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                            Borrar Empresas
                        </a>
